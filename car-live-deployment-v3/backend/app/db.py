...
def init_db():
    ...
    with conn() as c:
        ...
        CREATE TABLE IF NOT EXISTS session_items(
          session_id TEXT NOT NULL, item_id INTEGER NOT NULL, position INTEGER NOT NULL,
          text TEXT NOT NULL, revision INTEGER DEFAULT 0, played INTEGER DEFAULT 0,
          PRIMARY KEY(session_id, item_id)
        );
        CREATE INDEX IF NOT EXISTS session_items_order ON session_items(session_id, position);

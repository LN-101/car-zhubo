...
class Settings(BaseSettings):
    ...
    # with TTS_PROVIDER=gpt-sovits; Zhubo TTS is selectable with TTS_PROVIDER=zhubo.
    # `main._tts_provider()` also falls back to IndexTTS2 for an empty value, so both defaults agree.
